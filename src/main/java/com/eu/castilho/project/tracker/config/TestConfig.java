...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        projectList.add(new Project(null, "white", "04/02/2023 10:00", "07/03/2023 18:00", 50.0, null, null));
        projectList.add(new Project(null, "green", "02/05/2018 14:00", "07/08/2018 16:00", 50.0, null, null));
        projectList.add(new Project(null, "yellow", "02/05/2018 14:00", "02/05/2018 16:00", 50.0, null, null));
